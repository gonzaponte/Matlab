...
disp(' ')
% Pedimos que se introduza o coeficiente de sensibilidade.
s=input('Introducir o coeficiente de sensibilidade (en %): ');s=s/100;
t=input('Introducir o tempo de precaución en s: ');
